...
export interface TicketNFTInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "buyWithETH", values: [string]): string;
  encodeFunctionData(functionFragment: "buyWithLINK", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "linkPrice", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "linkPrice", data: BytesLike): Result;
...
export interface TicketNFT extends BaseContract {
  ...
  buyWithETH: TypedContractMethod<[uri: string], [bigint], "payable">;

  buyWithLINK: TypedContractMethod<[uri: string], [bigint], "nonpayable">;
  ...
  linkPrice: TypedContractMethod<[], [bigint], "view">;
  ...
  setPrices: TypedContractMethod<
    [_ethPrice: BigNumberish, _linkPrice: BigNumberish],
    [void],
    "nonpayable"
  >;
